# animation-orchestrator Capability

## Purpose
A centralized manager to coordinate the timing of entrance animations, specifically synchronization with the page loader and handling accessibility preferences.
